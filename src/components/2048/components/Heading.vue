...
<template>
  <div class="heading flex justify-start items-center ">
    <div class="scores flex flex-row">
      <div class="score score-now flex flex-raw items-center justify-center gap-2 relative">
      ...
      <div class="score flex flex-raw items-center justify-center gap-2 relative">
        <p class="label">Meilleur score</p>
