...
<template>
    ...
    <div class="flex flex-col h-full">
        ...
        <div 
            class="my-8 relative flex-1 flex flex-col items-center justify-center border-2 border-dashed rounded-3xl transition-all duration-500 overflow-hidden bg-(--text)/5"
            :class="[
            ...
            <div class="grid grid-cols-3 gap-2 p-2">
                ...
                >
                    ...
                    <div class="text-center">
                        <p class="text-[10px] font-bold leading-tight">1. Google Takeout</p>
                        <span class="text-[8px] opacity-50 tracking-tighter">Ouvrir le site</span>
                    </div>
                </a>
                ...
                <div class="flex flex-col items-center gap-3 p-4 rounded-2xl bg-(--text)/5 border border-(--text)/5">
                    ...
                    <div class="text-center">
                        <p class="text-[10px] font-bold leading-tight">2. Sélection</p>
                        <span class="text-[8px] opacity-50 tracking-tighter">Cochez "Keep"</span>
                    </div>
                </div>
                ...
                <div class="flex flex-col items-center gap-3 p-4 rounded-2xl bg-(--text)/5 border border-(--text)/5">
                    ...
                    <div class="text-center">
                        <p class="text-[10px] font-bold leading-tight">3. Export</p>
                        <span class="text-[8px] opacity-50 tracking-tighter">Fichier .zip</span>
                    </div>
                </div>
